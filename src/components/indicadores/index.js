...
class Indicadores extends Component{
    ...
    componentDidMount(){
        axios.get('http://10.17.12.218/ggnomotor/modules/indicadores/services/Last.php',{
        ...
        return (<div>
                   {
                    ...
                    return ( <Card className='medium' header={<CardTitle image={f.arquivo}>Indicadores - {f.mes}/{f.ano} </CardTitle>}
                                actions={[<div className="row"><div className="col s2"><a href="#/todosindicadores" className="btn-flat">Todos</a></div>
